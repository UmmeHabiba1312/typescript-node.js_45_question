...
let quote:string="safai nisf emaan hey";
let author:string="HM"
console.log(`${author} Once said, "${quote}"`);

 //task # 5
let person_name:string="HMS";
let quote1:string= "behtareen rizq apney hath ki kamai hey";
let message:string= `${person_name} once said, "${quote1}"`
console.log(message);
...
//task # 16
let myGuest2:string[]=["bhai","amna","iqra","manzoor"];
...
//task # 18
let favPlaces:string[]=["saudia arabia","pakistan","turkey","canada","dubai"];
//original order
...
//task # 19
let myGuest3:string[]=["bhai","amna","iqra","manzoor"];
...
let countries:string[]=["pakistan","saudia arabia","turkey","dubai","phalestin"] 
...
//task#24
//1st test
let testes1:string="Jug";
let testes2:string="glass";
...
// //4thrd test
let itom:string="ball";
let itom2:string="bat";
...
//task # 29
let myfavouriteFruites:string[] = ["apple", "banana","mango"];
...
//task # 30
let userName:string[]=["umer","ghulam","admin","ahmed","umm e habiba"];
...
//task # 31
let userName1:string[]=["umer","ghulam","admin","ahmed","umm e habiba"];
userName = []
...
// //task # 32
let current_users :string[]= ["mushaf","manal","amna","aisha","abdur rehman"]
let new_users:string[]=["aisha","abdur rehman","wajeeha","hanaf","shariq"];
...
//task # 38
function described_city(cityName:String="Karachi",countryName:String="Pakistan"){
...
function make_album(artistName:string,albumTitle:string,tracks?:number){
    let musicAlbum:{artist:string,album:string,tracks?:number}={
        artist:artistName,
        album:albumTitle,
    };
    if(tracks !== undefined){
...
//task # 41
let magicians:string[]=["rudra","shahkal","blindmagician","majestiko","shnaya"];
function show_magicians(magicians:string[]){
    magicians.forEach(names =>(console.log(names)));
}
let magicians_names:string[]=["rudra","shahkal","blindmagician","majestiko","shnaya"];
...
let magicians_names1:string[]=["rudra","shahkal","blindmagician","majestiko","shnaya"];
...
let magicians_names3:string[]=["rudra","shahkal","blindmagician","majestiko","shnaya"];
...
//task # 44
function makeSandwich(...itoms:string[]){
